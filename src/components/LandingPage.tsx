    ...
    >
      ...
      <header>
        <nav className="flex h-[7vh] justify-between px-7 lg:px-44 items-center">
          ...
          <button onClick={toggleTheme} aria-label="Toggle theme" className="hover:cursor-pointer">
            {theme === "light" ? <Moon size={20} /> : <Sun size={20} />}
          </button>
        </nav>
      </header>
      <section>
        <article className="relative h-[78vh] lg:h-[70vh] w-full flex items-center justify-center overflow-hidden">
          <motion.h1
